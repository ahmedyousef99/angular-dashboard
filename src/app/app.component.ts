...
export class AppComponent implements OnInit, OnDestroy {
  public networkStatus: OnlineStatusType = this.onlineStatusService.getStatus();
  ...
  ngOnInit(): void {
    ...
    this._coreConfigService.config
      ...
      .subscribe((config) => {
        ...
        // this.testHttp
        // .get<any>(`https://servi-qumo.onrender.com/api/v1/admin/booking-cancellation-order`, ).subscribe(
        //   (res) => {
        //     console.log(1111111);
        //   }, (err) => {
        //     console.log(`object`);
  ...
  public checkNetworkStatus(): void {
    this.onlineStatusService.status.subscribe((status) => {
      if (this.networkStatus === 0 && status === 1) {
