...
@Injectable()
export class BookingListService implements Resolve<any> {
  public rows: any;
  ...
  resolve(
    ...
    return new Promise<void>((resolve, reject) => {
      Promise.all([this.getAllBookings(this.searchData)]).then(() => {
        resolve();
      }, reject);
    });
  }
  ...
  public getAllBookings(searchData?: {
    page?: number;
    limit?: number;
    status?: string;
  ...
  public getBookingDetails(id: number): Observable<getBookingDetails> {
