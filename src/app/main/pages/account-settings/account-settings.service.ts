...
export class AccountSettingsService implements Resolve<any> {
   ...
   * Get rows
   */
  changePassword(changePasswordData:ChangePasswordData):Observable<ChangePasswordData> {
    return this._httpClient.patch<ChangePasswordData>(`${environment.apiUrl}admin/auth/change-password`,changePasswordData)
  }
